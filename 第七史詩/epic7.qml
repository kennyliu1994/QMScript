...
Sub GO_W()
    Do
        Call 寶箱()
        dm_ret = dm.CmpColor(211, 761, "ffc667", 1.0)
        If dm_ret = 0 Then
            MoveTo 211, 761
            Delay 400
            LeftClick 1
...
Sub 行動力不足dm()
    Delay 1000
    dm.FindStr 850,226,1066,279, "行動力不足","fcf7f0-303030|bec2b8-303030", 0.8,intX,intY
    If intX > 0 And intY > 0 Then 
        MoveTo 1073,719
        Delay 1000
        LeftClick 1
...
Sub 帳篷LL光鐮()    
    ...
    LeftClick 1
    Do
        dm.FindStr 203,65,276,114, "返回","fcf7f0-303030|bec2b8-303030", 1.0,intX,intY
        If intX > 0 And intY > 0 Then 
            MoveTo 1275,700
            Delay 1000
            LeftClick 1
    ...
    Loop
    Do
        dm.FindStr 1086,367,1262,421, "安慰助陣","fcf7f0-303030|bec2b8-303030", 1.0,intX,intY
        If intX > 0 And intY > 0 Then 
            MoveTo intX, intY 
            Delay 1000
            LeftClick 1
    ...
    Loop
    Do
        dm.FindStr 825,249,1083,303, "露營對話結果","fcf7f0-303030|bec2b8-303030", 1.0,intX,intY
        If intX > 0 And intY > 0 Then 
            MoveTo intX, intY 
            Delay 1000
            LeftClick 1
    ...
    Loop
    Do
        dm.FindStr 1087,487,1265,541, "傷心回憶","fcf7f0-303030|bec2b8-303030", 1.0,intX,intY
        If intX > 0 And intY > 0 Then 
            MoveTo intX, intY
            Delay 1000
            LeftClick 1
